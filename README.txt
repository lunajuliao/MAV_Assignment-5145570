...
These functions are called in the file yolo which is the main file which runs completing all the data processing, training, detection and ROCcurves tasks.
